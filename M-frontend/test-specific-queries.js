...
const isAllowedTopicTest = (query) => {
  ...
  const careerKeywords = [
    ...
    'athlete', 'sports', 'cricket', 'football', 'basketball', 'tennis',
    'olympics', 'professional sports', 'sports management', 'coach',
    'youtuber', 'content creator', 'influencer', 'streamer', 'social media',
    'performing arts', 'entertainment', 'celebrity', 'fame',
    ...
    'chef', 'cooking', 'culinary', 'baking', 'pastry', 'restaurant',
  ...
  const careerAspirationPhrases = [
    ...
    'study to become', 'course for', 'education for'
  ];
